...
TAB_ASTEROIDE:  ; tabela que define os 4 asteróides
    ...
    WORD 0, 0, 0, 0          ; asteróide 1
    WORD 0, 0, 0, 0          ; asteróide 2
    WORD 0, 0, 0, 0          ; asteróide 3
    WORD 0, 0, 0, 0          ; asteróide 4
...
PAR_COLUNA_DIRECAO:       ; tabela que define a coluna e a direção de cada 
                          ; asteróide e o seu estado (0 - inativo, 1 - ativo)
    WORD 0,  1, 0         ; asteróide à esquerda
    WORD 30, -1, 0        ; asteróide ao centro que se move na diagonal esquerda
    WORD 30, 0, 0         ; asteróide ao centro que se move na vertical
    WORD 30, 1, 0         ; asteróide ao centro que se move na diagonal direita
    WORD 59, -1, 0        ; asteróide à direita
