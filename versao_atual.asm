...
MODO_JOGO:    WORD 0    ; indica modo do jogo
                        ; 3 - desistência, 4 - energia esgotada, 5 - colisão 
...
; INICIO - inicializa o ecrã inicial do jogo e o teclado
...
fim_jogo:
    ...
    MOV R1, 1                      ; seleciona som final de jogo                       
    MOV [TOCA_SOM], R1   
    DI0
    DI1
    DI2
...
pausado:
    ...
    MOV R1, 2                      ; seleciona som de pausa   
    MOV [TOCA_SOM], R1              
    DI0
    DI1
    DI2
...
verifica_mineravel:
    MOV  R0, [R2]                ; copia tipo de asteróide
    CMP  R0, 1                   ; verifica se asteróide é minerável
    JNZ  toca_som_nao_mineravel  ; se não for, reinicia o asteróide
